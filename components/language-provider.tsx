...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'common.save': 'Save',
    'common.close': 'Close',
    'common.masterPrice': 'Master Price',
    'common.overridePrice': 'Override Price',
    ...
    'dashboard.salesAmount': 'Sales Amount',
    'dashboard.salesCount': 'Sales Count',
    'dashboard.purchaseAmount': 'Purchase Amount',
    'dashboard.purchaseCount': 'Purchase Count',
    'dashboard.monthlySummary': 'Monthly Summary',
    'dashboard.sales': 'Sales',
    'dashboard.purchases': 'Purchases',
    'dashboard.profit': 'Profit',
    'dashboard.alerts': 'Alerts',
    'dashboard.lowStockCount': 'Low Stock ({count})',
    'dashboard.expiryAlerts': 'Expiry Alerts ({count})',
    'dashboard.productsToBuy': 'Products to Buy ({count})',
    'dashboard.andMore': '...and {count} more',
    'dashboard.recommendedStock': 'Rec: {value}',
    'dashboard.sale': 'Sale',
    ...
    'products.buyingPrice': 'Buying Price (Rs)',
    'products.sellingPrice': 'Selling Price (Rs)',
    'products.minimumStockLevel': 'Minimum Stock Level',
    'products.fastMoving': 'Fast Moving Product',
    'products.expiryTracking': 'Track Expiry Dates',
    'products.active': 'Active',
    'products.buyingPriceNegative': 'Buying price cannot be negative',
    'products.sellingPriceNegative': 'Selling price cannot be negative',
    ...
    'products.type': 'Type',
    'products.addType': 'Add Type',
    'products.removeType': 'Remove Type',
    'products.variantName': 'Type Name',
    'products.variantNamePlaceholder': 'e.g., 500ml Packet',
    'products.size': 'Size / Weight / Volume',
    'products.sizePlaceholder': 'e.g., 500ml',
    'products.barcode': 'Barcode (Optional)',
    'products.barcodePlaceholder': 'Enter barcode',
    'products.variantRequired': 'Add at least one Type name',
    'products.searchTypes': 'Search products or Types',
    'products.lowStockTypes': 'Low stock Types ({count})',
    'products.typesCount': '{count} Types',
    ...
    'products.supplier': 'Supplier (Optional)',
    'products.searchTypes': 'Search products, brands, or pack sizes',
    'products.uncategorised': 'Uncategorised',
    'products.stockSummary': 'Stock: {stock} · Min: {minimum}',
    'products.buy': 'Buy',
    'products.sell': 'Sell',
    'products.typeHelp': 'Stock and prices are managed independently for each type.',
    'products.brandName': 'Brand Name *',
    'products.packSize': 'Pack Size / Weight / Volume *',
    'products.buyingPricePerUnit': 'Buying Price Per Unit *',
    'products.sellingPricePerUnit': 'Selling Price Per Unit *',
    'products.expiryDateOptional': 'Expiry Date (Optional)',
  ...
  ta: {
    ...
    'common.close': 'மூடு',
    'common.masterPrice': 'முதன்மை விலை',
    'common.overridePrice': 'விலையை மாற்றவும்',
    'common.batchNumber': 'தொகுதி எண்',
    'common.expiryDate': 'காலாவதி தேதி',
    'common.available': 'கிடைக்கும் இருப்பு',
    'common.totalAmount': 'மொத்த தொகை',
    'common.totalCost': 'மொத்த செலவு',
    ...
    'common.type': 'வகை *',
    'common.selectType': 'வகையைத் தேர்ந்தெடுக்கவும்',
    'common.perUnit': '{unit} ஒன்றுக்கு',
    ...
    'dashboard.title': 'மனாஸ் ஸ்டோர்ஸ்',
    ...
    'dashboard.performance': 'இன்றைய செயல்திறன்',
    'dashboard.salesAmount': 'விற்பனை தொகை',
    'dashboard.salesCount': 'விற்பனை எண்ணிக்கை',
    'dashboard.purchaseAmount': 'கொள்முதல் தொகை',
    'dashboard.purchaseCount': 'கொள்முதல் எண்ணிக்கை',
    'dashboard.monthlySummary': 'மாதாந்திர சுருக்கம்',
    'dashboard.sales': 'விற்பனை',
    'dashboard.purchases': 'கொள்முதல்',
    'dashboard.profit': 'லாபம்',
    'dashboard.alerts': 'எச்சரிக்கைகள்',
    'dashboard.lowStockCount': 'குறைந்த இருப்பு ({count})',
    'dashboard.expiryAlerts': 'காலாவதி எச்சரிக்கைகள் ({count})',
    'dashboard.productsToBuy': 'கொள்முதல் செய்ய வேண்டிய பொருட்கள் ({count})',
    'dashboard.andMore': '...மேலும் {count} பொருட்கள்',
    'dashboard.recommendedStock': 'பரிந்துரை: {value}',
    ...
    'products.buyingPrice': 'கொள்முதல் விலை (ரூ)',
    'products.sellingPrice': 'விற்பனை விலை (ரூ)',
    'products.minimumStockLevel': 'குறைந்தபட்ச இருப்பு நிலை',
    'products.fastMoving': 'வேகமாக விற்பனை ஆகும் பொருள்',
    'products.expiryTracking': 'காலாவதி தேதிகளை கண்காணிக்கவும்',
    'products.active': 'செயலில்',
    'products.buyingPriceNegative': 'கொள்முதல் விலை எதிர்மறையாக இருக்க முடியாது',
    'products.sellingPriceNegative': 'விற்பனை விலை எதிர்மறையாக இருக்க முடியாது',
    ...
    'products.types': 'வகைகள்',
    'products.type': 'வகை',
    'products.addType': 'வகையைச் சேர்க்கவும்',
    'products.removeType': 'வகையை அகற்றவும்',
    'products.variantName': 'வகை பெயர்',
    'products.variantNamePlaceholder': 'எ.கா., 500ml பாக்கெட்',
    'products.size': 'அளவு / எடை / கொள்ளளவு',
    'products.sizePlaceholder': 'எ.கா., 500ml',
    'products.barcode': 'பார்கோடு (விருப்பம்)',
    'products.barcodePlaceholder': 'பார்கோடை உள்ளிடவும்',
    'products.variantRequired': 'குறைந்தது ஒரு வகை பெயரைச் சேர்க்கவும்',
    'products.searchTypes': 'பொருட்கள் அல்லது வகைகளைத் தேடவும்',
    'products.lowStockTypes': 'குறைந்த இருப்பு வகைகள் ({count})',
    'products.typesCount': '{count} வகைகள்',
    'products.inStock': '{count} இருப்பில் உள்ளது',
    'products.nameRequired': 'பொருள் பெயர் தேவை.',
    'products.categoryRequired': 'வகை தேவை.',
    'products.details': 'பொருள் விவரங்கள்',
    'products.supplier': 'வழங்குநர் (விருப்பத்தேர்வு)',
    'products.searchTypes': 'பொருட்கள், பிராண்டுகள் அல்லது பேக் அளவைத் தேடவும்',
    'products.uncategorised': 'வகைப்படுத்தப்படாதது',
    'products.stockSummary': 'இருப்பு: {stock} · குறைந்தபட்சம்: {minimum}',
    'products.buy': 'கொள்முதல்',
    'products.sell': 'விற்பனை',
    'products.typeHelp': 'ஒவ்வொரு வகைக்கும் இருப்பு மற்றும் விலை தனித்தனியாக நிர்வகிக்கப்படும்.',
    'products.brandName': 'பிராண்ட் பெயர் *',
    'products.packSize': 'பேக் அளவு / எடை / கொள்ளளவு *',
    'products.buyingPricePerUnit': 'ஒரு அலகின் கொள்முதல் விலை *',
    'products.sellingPricePerUnit': 'ஒரு அலகின் விற்பனை விலை *',
    'products.expiryDateOptional': 'காலாவதி தேதி (விருப்பத்தேர்வு)',
